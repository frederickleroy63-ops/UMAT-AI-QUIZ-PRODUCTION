"""
UMAT AI — Answer Explanation Generator
=======================================
Generates detailed explanations for quiz answers using the Claude API.
Called by the backend after quiz submission.

Usage:
    python explain.py --attempt-id 1 --api-key YOUR_ANTHROPIC_KEY

Or import and call generate_explanations() directly.
"""
...
def generate_explanation(
    ...
    prompt = f"""You are an academic tutor at UMAT (University of Mines and Technology, Ghana).
